...
Файл: Disabled Person (100 frames) 15%, optimization.gif - Анимация 96x72 px (оптимизация).
Файл: Disabled Person (100 frames) 15%.gif               - Анимация 96x72 px.
Файл: Disabled Person (100 frames) 20%, optimization.gif - Анимация 128x96 px (оптимизация).
Файл: Disabled Person (100 frames) 20%.gif               - Анимация 128x96 px.
Файл: Disabled Person (100 frames) 25%, optimization.gif - Анимация 160x120 px (оптимизация).
Файл: Disabled Person (100 frames) 25%.gif               - Анимация 160x120 px.
Файл: Disabled Person (100 frames) 30%, optimization.gif - Анимация 192x144 px (оптимизация).
...
Файл: Disabled Person (200 frames) 15%, optimization.gif - Анимация 96x72 px (оптимизация).
Файл: Disabled Person (200 frames) 15%.gif               - Анимация 96x72 px.
Файл: Disabled Person (200 frames) 20%, optimization.gif - Анимация 128x96 px (оптимизация).
Файл: Disabled Person (200 frames) 20%.gif               - Анимация 128x96 px.
Файл: Disabled Person (200 frames) 25%, optimization.gif - Анимация 160x120 px (оптимизация).
Файл: Disabled Person (200 frames) 25%.gif               - Анимация 160x120 px.
Файл: Disabled Person (200 frames) 30%, optimization.gif - Анимация 192x144 px (оптимизация).
...
Disabled Person (400 frames) 15%, optimization.gif - Анимация 96x72 px (оптимизация).
Disabled Person (400 frames) 15%.gif               - Анимация 96x72 px.
Disabled Person (400 frames) 20%, optimization.gif - Анимация 128x96 px (оптимизация).
Disabled Person (400 frames) 20%.gif               - Анимация 128x96 px.
Disabled Person (400 frames) 25%, optimization.gif - Анимация 160x120 px (оптимизация).
Disabled Person (400 frames) 25%.gif               - Анимация 160x120 px.
Disabled Person (400 frames) 30%, optimization.gif - Анимация 192x144 px (оптимизация).
Disabled Person (400 frames) 30%.gif               - Анимация 192x144 px.

Disabled Person (400 frames).blend      - файл Blender'а 3D, ver. Blender'а 2.79b.
Disabled Person (400 frames).blend.copy - файл Blender'а 3D, ver. Blender'а 2.79b.
...
Файл: Readme - UTF8.txt - Описание для FreeBSD, Linux.
Файл: Readme - 1251.txt - Описание для Windows.
