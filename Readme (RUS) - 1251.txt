...
---
   ...
   Файлы Blender'а:
      ---
      | Disabled Person (099 frames).blend      - Blender ver. 2.79b.
      | Disabled Person (099 frames).blend.copy - Blender ver. 2.79b.
      ---
...
---
   ...
   Каталоги:
      ---
      | Disabled Person (400 frames) 15% - 400 кадров формата png, размер кадра 96x72 px.
      | Disabled Person (400 frames) 20% - 400 кадров формата png, размер кадра 128x96 px.
      | Disabled Person (400 frames) 25% - 400 кадров формата png, размер кадра 160x120 px.
      | Disabled Person (400 frames) 30% - 400 кадров формата png, размер кадра 192x144 px.
      ---

   Файлы GIF-анимации:
      ---
      | Disabled Person (400 frames) 15%, optimization.gif - Анимация 96x72 px (с оптимизацией).
      | Disabled Person (400 frames) 15%.gif               - Анимация 96x72 px.
      | Disabled Person (400 frames) 20%, optimization.gif - Анимация 128x96 px (с оптимизацией).
      | Disabled Person (400 frames) 20%.gif               - Анимация 128x96 px.
      | Disabled Person (400 frames) 25%, optimization.gif - Анимация 160x120 px (с оптимизацией).
      | Disabled Person (400 frames) 25%.gif               - Анимация 160x120 px.
      | Disabled Person (400 frames) 30%, optimization.gif - Анимация 192x144 px (с оптимизацией).
      | Disabled Person (400 frames) 30%.gif               - Анимация 192x144 px.
      ---

   Файлы Blender'а:
      ---
      | Disabled Person (400 frames).blend      - Blender ver. 2.79b.
      | Disabled Person (400 frames).blend.copy - Blender ver. 2.79b.
      ---
...
---
   ...
   Файл: Readme - UTF8.txt - Это описание в кодировке UTF-8 (FreeBSD, Linux).
   Файл: Readme - 1251.txt - Это описание в кодировке CP1251 (Windows).
